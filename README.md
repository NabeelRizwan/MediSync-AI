...
[Features](#-features) • [Demo](#%EF%B8%8F-demo) • [(Setup)Installation](#%EF%B8%8F-setupinstallation) • [Usage](#-usage) • [Architecture](#%EF%B8%8F-architecture) • [Results](#-results) • [Performance Metrics](#-performance-metrics)
